  ...
  return (
    <View style={{width: 400, borderWidth: 2, borderRadius: 30, paddingHorizontal: 15, paddingVertical:10, borderColor: themeMode.GENERALTEXT}}>
        <View style={{flexDirection: 'row', gap: 20, alignItems: 'center',}}>
            ...
            <Text style={{color: themeMode.GENERALTEXT}}>{label}</Text>
        </View>
        <TextInput value={inputValue} onChangeText={onChangeText} secureTextEntry={secure} style={{borderBottomWidth: 1, height: 40, borderColor:themeMode.GENERALTEXT, color:themeMode.GENERALTEXT}}/>
    </View>
  )
}
